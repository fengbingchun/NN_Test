...
- Python code(support windows and linux platform)
	...
	- Ultralytics
		...
		- Code
			...
			- [YOLOv8/YOLO11/YOLO26 train: detect/segment/classify/obb/semantic/pose](demo/Python/test_yolo.py)
			- [YOLOv8/YOLO11/YOLO26 predict: detect/segment/classify/obb/semantic/pose](demo/Python/test_yolo.py)
