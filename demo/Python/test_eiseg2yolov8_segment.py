...
if __name__ == "__main__":
	# python test_eiseg2yolov8_segment.py --dir ../../data/database/melon_new_segment --labels ../../data/images/labels.txt --val_size 0.15 --name melon_new_segment
	colorama.init()
	args = parse_args()
